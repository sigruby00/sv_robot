...
def main():
    ...
    # RTP based streaming
    # packages: sudo apt install gstreamer1.0-tools gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad
    # def camera_loop():
    #     # Start a GStreamer pipeline to send RTP packets
    #     gst_cmd = [
    #         'gst-launch-1.0',
    #         'fdsrc', '!',
    #         'h264parse', '!',
    #         'rtph264pay', '!',
    #         'udpsink', f'host={SERVER_URL_RTPS}', 'port=5002'
    #     ]

    #     # Create a subprocess to pipe camera data into GStreamer
    #     try:
    #         gst_proc = subprocess.Popen(gst_cmd, stdin=subprocess.PIPE)
    #         print("RTP streaming subprocess started.")
    #         while True:
    #             data, addr = cam_sock.recvfrom(100000)
    #             try:
    ...
    #             except Exception as e:
    #                 print(f"Failed to write to RTP stream: {e}")
    #     except Exception as e:
