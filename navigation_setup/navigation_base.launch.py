...
def launch_setup(context):
    ...
    bt_xml_file = LaunchConfiguration('bt_xml_filename').perform(context)
    ...
    print(f"[DEBUG] bt_xml_file path: {bt_xml_file}")
    ...
    load_composable_nodes = LoadComposableNodes(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                ...
                parameters=[
                    {
                        'default_nav_to_pose_bt_xml': ' /home/ubuntu/ros2_ws/src/navigation/behavior_trees/custom_bt.xml',
                        'default_nav_through_poses_bt_xml': ' /home/ubuntu/ros2_ws/src/navigation/behavior_trees/custom_bt.xml'
                    },
                    params_file
                ],
